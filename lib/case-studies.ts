...
a.	Establish the water consumption patterns for the site
b.	Improving the operation of already available treatment plants at the site
...
“This pilot project has been hugely successful and has helped us save water by 40%, thereby enabling us to maintain and double the stocks,” says Jiji Thomas, Associate Director, International Office Infrastructure Provider`,
  ...
  },
  {
    ...
    body: `Hospitality giant partners with Greenvironment to save water across its locations

The hospitality industry extracts and uses a substantial amount of freshwater water from natural sources while operating. WIth the rise in Green Tourism, it has become imperative for the industry adopt newer technologies to monitor of resource utilization in Real Time. Recent trends show that hospitality operators who promote sustainable management of water utilities, get an edge over the competitors.

A giant of the Indian hospitality space partnered with Greenvironement to install real time water management (RTM) systems across 15 of its prime properties across India. These include mountain resorts – Ooty, Madikeri, Virajpet, Munnar, Tungi, Naldehra, Shimla, Kandaghat and Kumbhalgarh, Water Front resorts – Ashtamudi, Alappuzha, Pondicherry, Goa Varca, Goa Emerald Palms and City resort in Diu.

Greenvironmentindia’s Real Time Monitoring (RTM) solutions for water utilities help the resorts manage their of water usage sustainably. The system helps for not just for the optimal use and re-use of water, but also as a way to keep its green building credentials.
...
Outcomes
Madikeri
Post the installation of the RTM, the treatment efficiency is increased by 30%, disinfection efficiency is increased by 32% and filtration efficiency is increased by 36%. Overall plant efficiency is increased by 33%.
Emerald Palms
Here, the treatment efficiency is increased by 50%, disinfection efficiency is increased by 43% and filtration efficiency is increased by 48%. The overall plant efficiency is increased by 47%.

Client Testimonial
SIte Chief Manager, Client Resort in Varca
...
SIte Chief Manager, Client Resort in Ooty
“Greenvironmentindia’s recycled water quality and monitoring system allows our engineer to make more informed, faster decisions to prevent severe discharge events. Overall, excellent technology and excellent service from Greenvironment”
Client Resort in Tungi
RTM helps to curtail dependency on fresh water and adds considerable economic benefits as well to the hospitality industry. Because fresh water, which is one of the bulk requirements for the industry, is becoming scarce and expensive day by day. RTM also helps the industry to adhere to the green norms by the government.`,
...
Cumulatively, over a span of four years there was 33% reduction in the consumption of freshwater.`,
  ...
  },
  {
    ...
    body: `Our client is a gated community of 172 apartments located in Sholinganallur that already had a Total Water Management System installed which helps them in Freshwater Monitoring, Tanker Monitoring and Recycled water Monitoring. Using the same, they were reusing their wastewater, even without a city sewer line, to its maximum capacity. Post the 2015 Chennai floods, this residential society faced a multitude of challenges with respect to its existing water and wastewater management.

Challenge
The Sewage Treatment Plant, which was following an Moving Bed Biofilm Reactor (MBBR) process was not operated properly. MBBR is a biological wastewater treatment process that uses suspended plastic carrier media to support biofilm growth for the removal of organic matter and nutrients. The improper use led to poor quality of treated water and raised major concerns among the residents. This led to an increase in dependency on Fresh water and increased its water bill. They also faced a huge challenge in asset management due to frequent failures of electro-mechanical equipment.
...
Solution
Greenvironment’s Real-Time Monitoring system for sewage treatment enables real time data collection, analysis and control tools using Internet Of Things (IoT) and a full array of smart sensors. Using analytics, the system identifies potential issues and helps in proactive decision making to further improve the reliability and the performance of a plant.
At the residential society, our team made the following improvements:
...
Implemented an automated chlorine-based disinfection system in the freshwater system to ensure treated water quality fit for reuse. The water quality was further regulated by ORP and supported by monthly bacterial strip testing, to detect and control E. coli and coliform presence.
...
<include graph/process from current site>Image description: Calculated overall plant efficiency using filtration efficiency, disinfection efficiency, and treatment efficiency
...
The Tamil Nadu Pollution Control Board bestowed the prestigious Green Awards to The Central Park South in June, 2019 for their tremendous efforts towards Water and Waste Management and Water savings.`,
  ...
  },
  {
    ...
    body: `The clients are a gated community with 228 apartments located at Chennai. A 200 KLD Sewage Treatment Plant (STP) was operational there as the STP treated water was designed to be reused for toilet flushing and gardening. But the challenges in improving and maintaining the STP’S performance was leading to poor quality treated water and sky rocketing water charges.

Challenge
The quality of recycled water was poor due to improper sewage treatment process, leading to treatment efficiency of only 30%. The disinfection was improper and the final treated water was odorous. Issues with frequent equipment failure resulted in high operational cost. Other issues faced at site include excessive sludge due to the absence of a sludge drying bed at Site.

Solution
In August 2018, Greenvironment installed the RTM system, an Internet of Things based solution, to troubleshoot issues and improve STP performance at the site. Using real time data from the RTM system, Greenvironment analyzed key performance parameters and recommended process corrections. The team replaced the raw sewage transfer pump with a 5HP cutter pump instead of a 2HP submersible pump. This upgrade increased flow rates, reduced operating hours, and supported energy conservation. The team also modified the piping from the collection tank to the aeration tank to maintain the batch cycle within the required timeline. Greenvironment replaced the pressure sand filter and activated carbon filter media due to poor filtration and treated water discoloration. To improve filtration efficiency and extend media life, the team changed the backwash line from filter feed water to treated water. The team installed sludge drying beds to enable effective removal of excess sludge. The site now repurposes the dried sludge as fertilizer for landscaping. Greenvironment also implemented an automatic ORP based chlorine dosing system to achieve consistent and reliable disinfection. These process improvements now allow the STP to produce treated water suitable for toilet flushing and gardening reuse.
...
Rs 40 Lakhs annual Saving on fresh water bill`,
  ...
  },
  {
    ...
    body: `Bengaluru’s fourth largest mall faced scrutiny over its use of natural water resources in the city due to the burgeoning demand of fresh water from commercial buildings.
...
Challenge
Larger floor area of a mall, its footfall centric operations and the need for comfortable as well as conducive ambience, rely on many systems that rely on water. To ensure water supply, water managers at the mall alternated between the highly priced water tankers and inconsistent municipality supplies. These mixed water sources added water challenges such as large fluctuations in inlet water quality and consistency in operational efficacy of the waste water treatment plants. The threat of running out of water was a constant companion large as often excessive demand led to delayed supply by tankers!

Solution
The major goal was to monitor the water usage pattern of Orion Mall to reduce the fresh water consumption by improving the efficiency of the treatment plants present at the site. The incorporation of the water conservation plan was based on a close 3-month study on the water usage pattern of the Mall. During the first three months of monitoring the water consumption, our observations showed that the largest water usage is divided between toilet flushing, landscaping consumption and cooling tower consumption.
Real Time Monitoring (RTM) of Effluent Treatment Plant, Smart Water Management and the Recycling / Reuse of waste water was recommended to curtail the dependence of fresh water sources. Installation of RTM, which is based on IoT, monitoring of water utilities and the availability of real time information on treated water quantity & quality, was done in the next phase.

Outcome
Previously the mall used freshwater for various purposes was 84%. By 2018 and 2019, over 49% of their daily consumption was now fulfilled through recycled water, which has also led to a 30% savings on water spend.
